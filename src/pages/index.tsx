  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine - Streamlining Your Dining Experience. A Revolutionary Restaurant Management App Where Customers Reserve Tables and Employees Manage Reservations and Menus."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine - Streamlining Your Dining Experience. A Revolutionary Restaurant Management App Where Customers Reserve Tables and Employees Manage Reservations and Menus.`}
            </Text>
            <Box
